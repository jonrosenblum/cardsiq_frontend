...
import {
  BaseComponent
} from "./chunk-SPHBI6F7.js";
import {
  BaseStyle
} from "./chunk-5LHHP6C4.js";
import {
  PrimeTemplate,
  SharedModule,
  isEmpty
} from "./chunk-QXWSMIO5.js";
import {
  CommonModule,
  NgClass,
  NgForOf,
...
var InputOtp = class _InputOtp extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    features: [ɵɵProvidersFeature([INPUT_OTP_VALUE_ACCESSOR, InputOtpStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature],
    decls: 1,
    vars: 2,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(InputOtp, {
    className: "InputOtp",
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(InputOtpModule, {
    imports: [InputOtp, SharedModule],
    exports: [InputOtp, SharedModule]
  });
})();
